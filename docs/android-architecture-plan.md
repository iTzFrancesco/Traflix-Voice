...
The current mobile build uses tag `android-v0.1.3`, versionName `0.1.3`, and
versionCode `1006001`, which is higher than the earlier preview's
`versionCode=1006000`. The custom updater is intentionally not shared with the
